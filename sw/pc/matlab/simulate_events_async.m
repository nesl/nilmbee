...
logfile = 'log/log-event-20min-3-async-simu.txt';
...
logfile = 'log/log-event-20min-4-async-simu.txt';
event_q = init_simulator(eventfile, rand(), 0.036);
pkt_state = packet_simulator_async(event_q);
output_simulator(pkt_state, logfile);
...
logfile = 'log/log-event-20min-5-async-simu.txt';
event_q = init_simulator(eventfile, rand(), 0.036);
pkt_state = packet_simulator_async(event_q);
output_simulator(pkt_state, logfile);
...
logfile = 'log/log-event-20min-6-async-simu.txt';
event_q = init_simulator(eventfile, rand(), 0.036);
pkt_state = packet_simulator_async(event_q);
output_simulator(pkt_state, logfile);
...
logfile = 'log/log-event-20min-7-async-simu.txt';
event_q = init_simulator(eventfile, rand(), 0.036);
pkt_state = packet_simulator_async(event_q);
output_simulator(pkt_state, logfile);
...
logfile = 'log/log-event-20min-8-async-simu.txt';
event_q = init_simulator(eventfile, rand(), 0.036);
pkt_state = packet_simulator_async(event_q);
output_simulator(pkt_state, logfile);
...
logfile = 'log/log-event-20min-10-async-simu.txt';
event_q = init_simulator(eventfile, rand(), 0.036);
pkt_state = packet_simulator_async(event_q);
output_simulator(pkt_state, logfile);
...
logfile = 'log/log-event-20min-12-async-simu.txt';
event_q = init_simulator(eventfile, rand(), 0.036);
pkt_state = packet_simulator_async(event_q);
output_simulator(pkt_state, logfile);
...
logfile = 'log/log-event-20min-15-async-simu.txt';
event_q = init_simulator(eventfile, rand(), 0.036);
pkt_state = packet_simulator_async(event_q);
output_simulator(pkt_state, logfile);
...
logfile = 'log/log-event-20min-20-async-simu.txt';
event_q = init_simulator(eventfile, rand(), 0.036);
pkt_state = packet_simulator_async(event_q);
output_simulator(pkt_state, logfile);
