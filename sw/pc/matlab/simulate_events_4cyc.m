...
logfile = 'log/log-event-20min-3-4cyc-simu.txt';
...
logfile = 'log/log-event-20min-4-4cyc-simu.txt';
event_q = init_simulator(eventfile, rand(), 0.036);
pkt_state = packet_simulator_4cyc(event_q);
output_simulator(pkt_state, logfile);
...
logfile = 'log/log-event-20min-5-4cyc-simu.txt';
event_q = init_simulator(eventfile, rand(), 0.036);
pkt_state = packet_simulator_4cyc(event_q);
output_simulator(pkt_state, logfile);
...
logfile = 'log/log-event-20min-6-4cyc-simu.txt';
event_q = init_simulator(eventfile, rand(), 0.036);
pkt_state = packet_simulator_4cyc(event_q);
output_simulator(pkt_state, logfile);
...
logfile = 'log/log-event-20min-7-4cyc-simu.txt';
event_q = init_simulator(eventfile, rand(), 0.036);
pkt_state = packet_simulator_4cyc(event_q);
output_simulator(pkt_state, logfile);
...
logfile = 'log/log-event-20min-8-4cyc-simu.txt';
event_q = init_simulator(eventfile, rand(), 0.036);
pkt_state = packet_simulator_4cyc(event_q);
output_simulator(pkt_state, logfile);
...
logfile = 'log/log-event-20min-10-4cyc-simu.txt';
event_q = init_simulator(eventfile, rand(), 0.036);
pkt_state = packet_simulator_4cyc(event_q);
output_simulator(pkt_state, logfile);
...
logfile = 'log/log-event-20min-12-4cyc-simu.txt';
event_q = init_simulator(eventfile, rand(), 0.036);
pkt_state = packet_simulator_4cyc(event_q);
output_simulator(pkt_state, logfile);
...
logfile = 'log/log-event-20min-15-4cyc-simu.txt';
event_q = init_simulator(eventfile, rand(), 0.036);
pkt_state = packet_simulator_4cyc(event_q);
output_simulator(pkt_state, logfile);
...
logfile = 'log/log-event-20min-20-4cyc-simu.txt';
event_q = init_simulator(eventfile, rand(), 0.036);
pkt_state = packet_simulator_4cyc(event_q);
output_simulator(pkt_state, logfile);
