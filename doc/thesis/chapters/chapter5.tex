...
Once we have reliable appliance power states and the step changes in the aggregated power, we can estimate the power traces of each individual appliance, according to the algorithm proposed previously. 
